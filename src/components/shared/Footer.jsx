        ...
        <footer className="bg-primary">
            <div className="mx-auto max-w-7xl">
                <div className="py-6 md:flex md:items-center md:justify-between">
                    <span className="text-sm sm:text-center">© 2025. <span className='font-semibold'>Artisio</span>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
                        ...
                        <Link href="https://www.x.com" target='_blank' className="">
                        ...
                        <Link href="https://www.github.com" target='_blank' className="">
